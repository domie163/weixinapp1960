<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的食堂窗口自助点餐系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shangjiaxingming" class="input" type="text" placeholder="商家姓名">
			   </div>
			 </div> -->
			<el-form-item label="商家姓名" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.shangjiaxingming" autocomplete="off" placeholder="商家姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='shangjia'" class="input-group">
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='shangjia'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if(`shangjia` == this.tableName && this.ruleForm.dianhuahaoma&&(!this.$validate.isMobile(this.ruleForm.dianhuahaoma))){
        this.$message.error(`电话号码应输入手机格式`);
        return
      }
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20210312/9c5a9038de3c4a6299acec3285b493b0.jpg);

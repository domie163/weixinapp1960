  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.caipinbianhao" label="菜品编号" prop="caipinbianhao">
              <el-input v-model="ruleForm.caipinbianhao" 
                placeholder="菜品编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="店铺信息" prop="dianpuxinxi">
          <el-select :disabled="ro.dianpuxinxi" v-model="ruleForm.dianpuxinxi" placeholder="请选择店铺信息">
            <el-option
                v-for="(item,index) in dianpuxinxiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="店铺信息" prop="dianpuxinxi">
	      <el-input v-model="ruleForm.dianpuxinxi"
                placeholder="店铺信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
		...
		if(json.shangjiaxingming!=''&&json.shangjiaxingming){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              ...
              if (data && data.code === 0) {
                this.dianpuxinxiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../ssmjj58f/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
